...
struct PeriodIncomeWagesTests {
    ...
    func nilWhenRateUnset() {
        ...
        #expect(PeriodIncome.wages(payrollTimeZone: PaydayTestZone.payroll, entries: entries, wageCentsPerHour: nil, firstWeekday: nil) == nil)
    }
    ...
    func nilWhenNoHours() {
        ...
        #expect(PeriodIncome.wages(payrollTimeZone: PaydayTestZone.payroll, entries: entries, wageCentsPerHour: 2000, firstWeekday: nil) == nil)
    }
    ...
    func exactly40HoursIsAllRegular() {
        ...
        let wages = PeriodIncome.wages(payrollTimeZone: PaydayTestZone.payroll, entries: entries, wageCentsPerHour: 2000, firstWeekday: 2)
    ...
    func roundsFractionalCents() {
        ...
        let wages = PeriodIncome.wages(payrollTimeZone: PaydayTestZone.payroll, entries: entries, wageCentsPerHour: 283, firstWeekday: 2)
    ...
    func twoWorkweeksBucketIndependently() {
        ...
        let wages = PeriodIncome.wages(payrollTimeZone: PaydayTestZone.payroll, entries: [weekOne, weekTwo], wageCentsPerHour: 2000, firstWeekday: 2)
    ...
    func weekBoundaryRespectsFirstWeekday() {
        ...
        let mondayStart = PeriodIncome.wages(payrollTimeZone: PaydayTestZone.payroll, entries: [saturday, sunday], wageCentsPerHour: 2000, firstWeekday: 2)
        ...
        let sundayStart = PeriodIncome.wages(payrollTimeZone: PaydayTestZone.payroll, entries: [saturday, sunday], wageCentsPerHour: 2000, firstWeekday: 1)
